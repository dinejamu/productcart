        ...
        <form action="/add-product" method="post" enctype="multipart/form-data">
            ...
            <tr><td>Product Price :</td><td><input type="number" name="price" class="form-control"></td></tr>
                <tr><td> <div class="form-group">
                    <label for="sel1">Status :</label></div></td>
                    <td> <select class="form-control" id="sel1" name="productstatus">
            ...
            <tr><i class="bi bi-image"></i><td><i class="cid-image-plus"></i>Product Image : </td><td><input type="file" name="image" id="image1" class="choose" required multiple accept="image/jpg, image/jpeg"> </td></tr>
